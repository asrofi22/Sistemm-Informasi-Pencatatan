			...
			<div class="pd-ltr-20">
				...
				<div class="row">
					...
					<!-- <div class="col-xl-3 mb-30">
						<a href="<?=base_url();?>Logbook/logbook_s">
						<div class="card-box height-100-p widget-style1">
							<div class="d-flex flex-wrap align-items-center">
								...
								<a href="<?=base_url();?>Logbook/view_kaurrt" class="small-box-footer"> More info <i class="fas fa-arrow-circle-right"></i></a>
							</div>
						</div>
						</a>
					</div> -->
					<div class="col-xl-3 mb-30">
						<a href="<?=base_url();?>Izin/view_kaurrt/<?= $this->session->userdata('id_user'); ?>">
						<div class="card-box height-100-p widget-style1">
							<div class="d-flex flex-wrap align-items-center">
								<div class="progress-data">
					...
					<div class="col-xl-3 mb-30">
						<a href="<?=base_url();?>Perbaikanbmn/view_kaurrt/<?= $this->session->userdata('id_user'); ?>">
						<div class="card-box height-100-p widget-style1">
							<div class="d-flex flex-wrap align-items-center">
								<div class="progress-data">
					...
					<div class="col-xl-3 mb-30">
						<a href="<?=base_url();?>Suratmasuk/view_kaurrt">
						<div class="card-box height-100-p widget-style1">
							<div class="d-flex flex-wrap align-items-center">
								<div class="progress-data">
					...
					<!-- <div class="col-xl-3 mb-30">
						<a href="<?=base_url();?>kaurrt/view_kaurrt">
						<div class="card-box height-100-p widget-style1">
							<div class="d-flex flex-wrap align-items-center">
								<div class="progress-data">
								<img src="<?= base_url();?>assets/images/kaurrtic.png" alt="kaurrt Logo" class="icon-img"/>
								</div>
								<div class="widget-data">
									<div class="h4 mb-0"><?=$kaurrt['total_user']?></div>
									<div class="weight-600 font-14">Data kaurrt</div>
								</div>
								<a href="<?=base_url();?>Logbook/view_kaurrt" class="small-box-footer"> More info <i class="fas fa-arrow-circle-right"></i></a> 
							</div>
						</div>
