		...
		<div class="main-container">
			<div class="pd-ltr-20">
				...
				<div class="row">
					...
					<div class="col-xl-3 mb-30">
						<a href="<?=base_url();?>Izin/view_pegawai/<?= $this->session->userdata('id_user'); ?>">
						<div class="card-box height-100-p widget-style1">
							<div class="d-flex flex-wrap align-items-center">
								<div class="progress-data">
					...
					<div class="col-xl-3 mb-30">
						<a href="<?=base_url();?>Perbaikanbmn/view_pegawai/<?= $this->session->userdata('id_user'); ?>">
						<div class="card-box height-100-p widget-style1">
							<div class="d-flex flex-wrap align-items-center">
								<div class="progress-data">
					...
					<div class="col-xl-3 mb-30">
						<a href="<?=base_url();?>Suratmasuk/view_pegawai">
						<div class="card-box height-100-p widget-style1">
							<div class="d-flex flex-wrap align-items-center">
								<div class="progress-data">
					...
					<!-- <div class="col-xl-3 mb-30">
						<a href="<?=base_url();?>Pegawai/view_pegawai">
						<div class="card-box height-100-p widget-style1">
							<div class="d-flex flex-wrap align-items-center">
								<div class="progress-data">
