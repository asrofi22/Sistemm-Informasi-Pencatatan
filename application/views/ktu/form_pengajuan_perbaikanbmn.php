...
<body class="hold-transition sidebar-mini layout-fixed">
                    ...
                    <div class="row">
                        <div class="col-12 mb-30">
                            <div class="pd-20 card-box height-100-p">
                                <form id="formPengajuanPerbaikanbmn" action="<?= base_url();?>Form_perbaikanbmn/proses_perbaikanbmn_ktu" method="POST" enctype="multipart/form-data">
    ...
    <?php $this->load->view("ktu/components/js.php") ?>
        ...
        $(document).ready(function () {
            ...
            form.submit(function (event) {
                ...
                $.ajax({
                    ...
                    error: function () {
                        alert('Gagal mengajukan perbaikan BMN karena data sudah tersimpan.');
                    }
                });
            });
        });
