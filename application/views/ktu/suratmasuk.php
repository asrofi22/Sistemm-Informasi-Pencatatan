                                ...
                                <tr>
                                    ...
                                    <td class="table-plus">
                                        <?php if($id_status_surat == 1) { ?>
                                            <a href="#" class="btn btn-info btn-sm" data-target="#edit_data_ktu">Menunggu Konfirmasi</a>
                                        <?php } elseif($id_status_surat == 2) { ?>
                                            <a href="#" class="btn btn-success btn-sm" data-target="#edit_data_ktu">Surat Didisposisikan</a>
                                        <?php } ?>
                                    </td>
