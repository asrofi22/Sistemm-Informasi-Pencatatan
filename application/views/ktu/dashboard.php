			...
			<div class="pd-ltr-20">
				...
				<div class="row">
					...
					<div class="col-xl-3 mb-30">
						<a href="<?=base_url();?>Logbook/view_ktu">
						<div class="card-box height-100-p widget-style1">
							<div class="d-flex flex-wrap align-items-center">
								...
								<!-- <a href="<?=base_url();?>Logbook/view_ktu" class="small-box-footer"> More info <i class="fas fa-arrow-circle-right"></i></a> -->
							</div>
						</div>
						</a>
					</div>
					<div class="col-xl-3 mb-30">
						<a href="<?=base_url();?>Izin/view_ktu">
						<div class="card-box height-100-p widget-style1">
							<div class="d-flex flex-wrap align-items-center">
								<div class="progress-data">
					...
					<div class="col-xl-3 mb-30">
						<a href="<?=base_url();?>Perbaikanbmn/view_ktu">
						<div class="card-box height-100-p widget-style1">
							<div class="d-flex flex-wrap align-items-center">
								<div class="progress-data">
					...
					<div class="col-xl-3 mb-30">
						<a href="<?=base_url();?>Suratmasuk/view_ktu">
						<div class="card-box height-100-p widget-style1">
							<div class="d-flex flex-wrap align-items-center">
								<div class="progress-data">
					...
					<div class="col-xl-3 mb-30">
						<a href="<?=base_url();?>Pegawai/view_ktu">
						<div class="card-box height-100-p widget-style1">
							<div class="d-flex flex-wrap align-items-center">
								<div class="progress-data">
