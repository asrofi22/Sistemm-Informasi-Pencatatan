            ...
            <div id="monthlyLogbookTable" class="card-box mb-30">
                <div class="pd-20">
                    ...
                    <div class="col-md-1 align-bottom">
                        <!-- <button id="filterData" class="btn btn-primary">Filter</button> -->
                    ...
                    <table class="data-table table stripe hover nowrap">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="table-plus">
                                    <a href="#" data-toggle="modal" data-target="#detail<?= $id_log ?>" class="btn btn-info btn-sm"><i class="icon-copy bi bi-eye"></i></a>
                                    <a href="#" data-toggle="modal" data-target="#setuju<?= $id_log ?>" class="btn btn-success btn-sm"><i class="icon-copy bi bi-pencil"></i></a>
                                </td>
                                
                                
                            </tr><!-- Modal Setuju logbook -->
                                            <div class="modal fade" id="setuju<?= $id_log ?>" tabindex="-1"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                        <form action="<?php echo base_url()?>Logbook/acc_logbook_ktu/2" method="post" enctype="multipart/form-data">
                                                            <div class="row">
                                                                <div class="col-md-12">
