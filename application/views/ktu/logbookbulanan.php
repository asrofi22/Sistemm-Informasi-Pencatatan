                ...
                <div class="page-header">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12 text-right">
                            <a href="<?= base_url();?>Logbook/view_ktu/<?= $this->session->userdata('id_user'); ?>" class="btn btn-primary mr-2">Logbook Harian</a>
                            <a href="<?= base_url();?>Logbookbulanan/view_ktu/<?= $this->session->userdata('id_user'); ?>" class="btn btn-primary">Logbook Bulanan</a>
                        </div>
                                    ...
                                    <td>
                                        ...
                                        <?php elseif($id_status_log == 2): ?>
                                            ...
                                            class="table-responsive">
                                                <div class="table table-striped table-hover ">
                                                    <a href="" class="btn btn-success btn-sm" data-toggle="modal" data-target="#edit_data_pegawai">Telah Dinilai</a>
                                                </div>
                                            </div>
                                        <?php endif; ?>
                                    </td>
                                ...
                                <div class="modal fade" id="setuju<?= $id_log ?>" tabindex="-1"
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <form action="<?php echo base_url()?>Logbookbulanan/acc_logbookbulanan_ktu/2" method="post" enctype="multipart/form-data">
                                                            <div class="row">
                                                                <div class="col-md-12">
