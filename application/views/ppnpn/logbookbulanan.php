        ...
        <div class="pd-ltr-20 xs-pd-20-10">
            <div class="min-height-200px">
                <div class="page-header">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12 text-right">
                            <a href="<?= base_url();?>Logbook/view_ppnpn/<?= $this->session->userdata('id_user'); ?>" class="btn btn-primary mr-2">Logbook Harian</a>
                            <a href="<?= base_url();?>Logbookbulanan/view_ppnpn/<?= $this->session->userdata('id_user'); ?>" class="btn btn-primary">Logbook Bulanan</a>
                        </div>
                ...
                <div class="card-box mb-30">
                    ...
                    <div class="pb-20">
                        ...
                        <!-- Modal Form Logbook Bulanan PPNPN -->
                        <div class="modal fade" id="formLogbookbulananModal" tabindex="-1" role="dialog" aria-labelledby="formLogbookbulananModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="formLogbookbulananModalLabel">Form Logbook Bulanan</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <form action="<?= base_url();?>Logbookbulanan/proses_logbook_bulanan_ppnpn" method="POST" enctype="multipart/form-data">
            ...
            <script>
                $(document).ready(function() {
                    ...
                    $('#ajukanLogbookbulananButton').click(function () {
                        $('#formLogbookbulananModal').modal('show');
                    });
                });
            </script>
        </div>
