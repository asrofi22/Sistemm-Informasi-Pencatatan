                    ...
                    <div class="page-header">
                        <div class="row">
                            <div class="col-md-12 col-sm-12">
                                <div class="title">
                                    <h4>Form Logbook Bulanan PPNPN</h4>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-12 mb-30">
                            <div class="pd-20 card-box height-100-p">
                                <form id="formPengajuanPerbaikanbmn" action="<?= base_url();?>Form_logbookbulanan/proses_logbook_bulanan_ppnpn" method="POST" enctype="multipart/form-data">
