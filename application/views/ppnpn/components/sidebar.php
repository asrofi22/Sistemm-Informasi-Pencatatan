...
<div class="right-sidebar">
		...
		<div class="left-side-bar">
			<div class="brand-logo">
				<a href="<?= base_url();?>Dashboard/dashboard_ppnpn" class="nav-link">
			...
			<div class="menu-block customscroll">
				<div class="sidebar-menu">
					<ul id="accordion-menu">
						<li class="dropdown">
							<a href="<?= base_url();?>Dashboard/dashboard_ppnpn" class="dropdown-toggle no-arrow">
						...
						<li>
							<a href="<?= base_url();?>Profile/view_ppnpn" class="dropdown-toggle no-arrow">
								<span class="micon bi bi-person"></span
								><span class="mtext">Profil</span>
							</a>
						</li>
                        <li>
							<a href="<?= base_url();?>Settings/view_ppnpn" class="dropdown-toggle no-arrow">
