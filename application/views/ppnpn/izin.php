                ...
                <div class="page-header">
                    <div class="row">
                        ...
                        <div class="col-md-6 col-sm-12 text-right">
                            <a href="<?php echo base_url('Form_izin/view_ppnpn'); ?>" class="btn btn-primary">
                                Ajukan Izin
                            </a>
                        </div>
                    </div>
        ...
        <div class="modal fade" id="formPengajuanIzinModal" tabindex="-1" role="dialog" aria-labelledby="formPengajuanIzinModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="<?= base_url();?>Izin/proses_izin_ppnpn" method="POST" enctype="multipart/form-data">
